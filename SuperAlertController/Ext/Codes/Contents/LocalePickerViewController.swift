...
extension UIAlertController {
    ...
    public func addLocalePicker(type: LocalePickerViewController.Kind, action: LocalePickerViewController.LocalePickerAction?) {
...
public final class LocalePickerViewController: UIViewController {
    ...
    public typealias LocalePickerAction = (Info?) -> Swift.Void
    ...
    public required init(type: Kind, action: LocalePickerAction?) {
        self.type = type
        self.action = action
