...
extension UIAlertController {
    ...
    public func addTwoTextFields(height: CGFloat = 58, hInset: CGFloat = 0, vInset: CGFloat = 0, textFieldOne: TextField.Config?, textFieldTwo: TextField.Config?) {
        ...
        self.setContentViewController(textField, height: height * 2 + 2 * vInset)
    }
}

public final class TwoTextFieldsViewController: UIViewController {
    
    lazy public private(set) var textFieldView: UIView = UIView()
    lazy public private(set) var textFieldOne: TextField = TextField()
    lazy public private(set) var textFieldTwo: TextField = TextField()
