...
extension UIImage {
    ...
    ///
    internal func imageWithSize(size: CGSize) -> UIImage? {
    ...
    ///
    internal func imageWithSize(size: CGSize, extraMargin: CGFloat) -> UIImage? {
    ...
    ///
    internal func imageWithSize(size: CGSize, roundedRadius radius: CGFloat) -> UIImage? {
